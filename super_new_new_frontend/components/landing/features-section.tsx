...
const features = [
  {
    ...
    description: "AdScience AI classifies your browsing history into 5 interest categories entirely in-browser. Zero data leaves your device during classification.",
    visual: "ai",
  },
  {
    number: "02",
    title: "Fully Homomorphic Encryption",
    description: "Your intent vector is encrypted via the CoFHE ZK proof pipeline before leaving the device. Advertisers never see your raw data.",
    visual: "security",
  },
  {
    number: "03",
    title: "Blind Ad Matching",
    description: "Advertisers bid on encrypted intents on-chain. FHE computation reveals only the winning match index — nothing else.",
    visual: "deploy",
  },
  {
    number: "04",
    title: "Cross-Site Ad Serving",
    description: "The EAX SDK delivers matched ads on any publisher site. Users earn ATTN tokens for every impression, creating a fair attention economy.",
    visual: "collab",
  },
];

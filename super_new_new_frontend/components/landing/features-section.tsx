...
const features = [
  {
    ...
    description: "MobileBERT classifies your browsing history into 5 interest categories entirely in-browser. Zero data leaves your device during classification.",
    visual: "ai",
  },
  {
    number: "02",
